    ...
    return (
        <Container maxWidth="xl" sx={{ height: { xs: '200px', sm: '250px' } }}>
            <Box sx={{ display: 'flex', alignItems: 'center', padding: { xs: '1em 0', sm: '1.5em 0', md: '2.5em 1em', lg: '4em 1em' } }}>
                <Box>
                    ...
                    <Box sx={{ display: 'flex', gap: { xs: '10px', md: '15px' } }}>
                        ...
                        <IconButton sx={{ width: { xs: "18px", sm: "24px" }, padding: 0 }}>
                            <svg width="inherit" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Box sx={{ flexGrow: 1, display: { xs: 'flex', lg: 'none' }, alignSelf: "self-start", justifyContent: "flex-end" }}>
                    <IconButton
                        size="large"
